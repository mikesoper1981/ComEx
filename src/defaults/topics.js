...
export const DEFAULT_TOPICS = [
  ...
  },
  {
    ...
    workflow: [
      { step: 1, name: 'Extract & Analyze', agents: ['analysis_agent'], goal: 'Extract key scheme info and assess against 6 Fundamental Axes only', successCriteria: 'Scheme structure extracted; 6-axes strengths/gaps noted; STOP — no full compliance checklist and no final report' },
      ...
      { step: 3, name: 'Generate Report', agents: ['communication_agent'], goal: 'Create the final assessment report from prior steps', successCriteria: 'Detailed report with ranked recommendations' },
    ],
    status: 'active',
  },
  {
